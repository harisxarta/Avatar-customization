// PlayCanvasScripts.js

export function registerPlayCanvasScripts(pc) {
  ...
  class MobileInput {
    ...
    _onTouchStart(e) {
      ...
      for (let i = 0; i < touches.length; i++) {
        ...
        if (
          touch.pageX <= this._canvas.clientWidth / 2 &&
  ...
  // Define and initialize all scripts
